...
add_library(Group_Program_User_Src OBJECT
  ...
  "${SOLUTION_ROOT}/Src/onewire_functions.c"
  "${SOLUTION_ROOT}/Src/gpiod_manip.c"
  "${SOLUTION_ROOT}/Src/custom_time.c"
  "${SOLUTION_ROOT}/Src/custom_error.c"
  "${SOLUTION_ROOT}/Src/read_write.c"
  "${SOLUTION_ROOT}/Src/display_output.c"
)
